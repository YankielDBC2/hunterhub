...
const allImages = [
  { src: '/images/Techpass.png', size: 40 },
  { src: '/images/mechapass.png', size: 40 },
  { src: '/images/pala.png', size: 40 },
  { src: '/images/flotar1.png', size: 40 },
  { src: '/images/flotar2.png', size: 40 },
  { src: '/images/flotar3.png', size: 40 },
]

const MIN_DISTANCE = 90
const MAX_FLOATING = 2 // menos en mobile para evitar saturación

export default function FloatingObjectsMobile() {
  ...
  const spawnNewImage = (index, el) => {
    ...
    timers.current[index] = {
      timeLeft: 5000 + Math.random() * 3000,
      fadingOut: false,
      fadingIn: true,
    }
